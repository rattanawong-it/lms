 ...
 * จำนวนครั้งต่อรอบตอนนี้: setup 4 ครั้ง + เทสต์ล็อกอินจริงอีก 1 ครั้ง (เฉพาะ desktop) = 5 เต็มโควตาพอดี
 * — เพิ่มบัญชีอีกไม่ได้แล้ว และรันชุดเต็มซ้ำภายใน 15 นาทีไม่ได้ (ใช้ `--no-deps` ระหว่างพัฒนา)
 */
